...
centerline = np.array([0.01,0,0])/2		#centerline: the xy coordinate of the centerline of the mesh (NORMALLY ZERO) also dictates the rotation of the mesh
"""
...
def vects(nodes,center): 
	#nodes['X'] = ""
	#nodes['V'] = ""
	nodes[['z']] = nodes[['z']] * 0.004064
	nodes[['x']] = nodes[['x']] * 0.01
