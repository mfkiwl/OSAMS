...
g_code_path = OSAMS.out.read_string(r_file,'GCODE')
g_code = open(g_code_path,'r').read()
...
print(f'NUMBER OF PRE MERGE NODES: {nodes.shape[0]}')
...
print(f'NUMBER OF POST MERGE NODES: {nodes.shape[0]}')
"""
...
print(f'NUMBER OF STEPS: {steps.shape[0]}')
